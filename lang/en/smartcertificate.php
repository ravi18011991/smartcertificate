...
$string['manageinstitutiondesc'] = 'This button will take you to a new screen where you will be able to add valid institution which is registered in linkedin.';
...
$string['selectcompanyname'] = 'Select Institute';
$string['selectcompanyname_help'] ='Select your Institute,which is running your certification course.if your institute is not avail in list then you need to contact administrator'; 
