...
class mod_smartcertificate_generator extends testing_module_generator {

    /**
     * Create new smartcertificate module instance
    ...
    public function create_instance($record = null, array $options = null) {
        ...
        $defaults = array();
        $defaults['name'] = get_string('pluginname', 'smartcertificate').' '.$i;
        $defaults['intro'] = 'Test smartcertificate '.$i;
        $defaults['introformat'] = FORMAT_MOODLE;
        $defaults['emailteachers'] = 0;
        $defaults['savecert'] = 0;
        $defaults['reportcert'] = 0;
        $defaults['delivery'] = 0;
        $defaults['smartcertificatetype'] = 'A4_non_embedded';
